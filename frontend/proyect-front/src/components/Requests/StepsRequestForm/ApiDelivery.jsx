...
const ApiDeliveryForm = ({ formData, control, errors }) => {
  ...
  const [logisticaAvailable, setLogisticaAvailable] = useState(true);
  ...
  return (
    <div className="mt-3">
      {logisticaAvailable ? (
        ...
        <div className="error">No se pudo conectar con el servicio de envios. Por favor, intente nuevamente más tarde</div>
      )}
    </div >
  );
}
