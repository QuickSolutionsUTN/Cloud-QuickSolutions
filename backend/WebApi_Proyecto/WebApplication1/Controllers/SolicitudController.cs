    ...
    public class SolicitudController : ControllerBase
    {
        ...
        public async Task<IActionResult> ActualizarEstadoUser(int solicitudId, [FromBody] SolicitudServicioEstadoUpdateDTO solicitudServicioEstadoUpdateDTO)
        {
            try
            {
                ...
                {
                    return BadRequest(new { message = "La solicitud no se encuentra en un estado v�lido para actualizar su estado." });
                }
                ...
                {
                    return Forbid("Id para cambio de estado inv�lido, debe ser 'Aprobada' o 'Rechazada'.");
                }
